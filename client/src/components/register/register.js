  ...
  return (
    <>
     ...
     <YourSvg className=" w-"/>
            ...
            <div class="col-span-2">
              <button
                class="bg-purple-500 shadow-lg shadow-purple-500/50 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-purple-400/50 focus:shadow-outline transition ease-in-out delay-50  hover:-translate-y-0.5 hover:scale-110 duration-100  "
                type="submit"
