...
const order = () => {
  return (
    <div>
      <MeasurementForm/>
    <div class="max-w-sm rounded overflow-hidden  w-48 ml-2 shadow-md shadow-purple-300 absolute top-48 left-0  drop-shadow-lg">
      <div className= " flex flex-col align-center   rounded-md   ">
          <label class="m-3 font-semibold text-purple-700">Top
        <select id ="top" className='w-auto shadow-sm mr-6  text-gray-500 shadow-purple-300 outline-purple-400 rounded-md h-auto '>
        ...
        <select id ="top" className='w-auto shadow-sm m-auto text-gray-500 shadow-purple-300 outline-purple-400 rounded-md h-auto '>
